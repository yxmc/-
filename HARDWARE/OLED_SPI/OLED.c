...
void OLED_W_D0(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_D0, OLED_D0_IO, (BitAction)BitValue);
...
void OLED_W_D1(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_D1, OLED_D1_IO, (BitAction)BitValue);
...
void OLED_W_RES(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_RES, OLED_RES_IO, (BitAction)BitValue);
...
void OLED_W_DC(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_DC, OLED_DC_IO, (BitAction)BitValue);
...
void OLED_W_CS(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_CS, OLED_CS_IO, (BitAction)BitValue);
...
void OLED_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = OLED_D0_IO;
	GPIO_Init(OLED_D0, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = OLED_D1_IO;
	GPIO_Init(OLED_D1, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = OLED_RES_IO;
	GPIO_Init(OLED_RES, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = OLED_DC_IO;
	GPIO_Init(OLED_DC, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = OLED_CS_IO;
	GPIO_Init(OLED_CS, &GPIO_InitStructure);
